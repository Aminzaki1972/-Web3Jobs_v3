...
(function () {
    ...
    /* =========================================================
       SUPABASE CLIENT
       IMPORTANT:
       Use the existing global Web3JobsSupabase client.
       Do NOT create a second auth session.
       ========================================================= */
    ...
    function getJobsSupabase() {
        ...
        if (
            ...
            typeof window.Web3JobsSupabase.from === "function"
        ) {
            return window.Web3JobsSupabase;
        }

        /* Existing generic Supabase client */
        if (
        ...
        /* Existing client named client */
        if (
            window.client &&
            typeof window.client.from === "function"
        ) {
        ...
        /*
         * Last fallback:
         * create a client only if the project does not
         * already expose one.
         *
         * This uses the same credentials but does not
         * redirect the user.
         */
        ...
        if (
            ...
            try {
                ...
                if (!window.__Web3JobsJobsClient) {

                    window.__Web3JobsJobsClient =
                ...
                return window.__Web3JobsJobsClient;

            } catch (error) {

                console.error(
                    "Web3Jobs: Unable to initialize Supabase:",
                    error
                );
    ...
    async function getCurrentUser() {
        ...
        try {
            ...
            /*
             * getSession() reads the existing session.
             * It does not force a login.
             */
    ...
    function buildSupabaseError(error) {
    ...
    async function applyForJob(jobId) {
        ...
        if (!user) {
             ...
             *
             * The user stays on the jobs page.
             */
